...
public class AddTrainFragment extends Fragment {
	...
	private TextInputEditText trainNumberEditText, trainNameEditText, sourceEditText,
			departureDateEditText, departureTimeEditText, destinationEditText, arrivalDateEditText
			, arrivalTimeEditText, numberOfSeatsEditText, fareEditText;
